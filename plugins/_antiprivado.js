...
await m.reply(`Hola *@${m.sender.split`@`[0]}*, NO PUEDE USAR ESTE BOT EN CHAT PRIVADO POR ESO SERA BLOQUEADO \n\nSi fue bloquedao por error comuniquese con wa.me/595986637644 para su debloqueo\n${nn}`, false, { mentions: [m.sender] })
